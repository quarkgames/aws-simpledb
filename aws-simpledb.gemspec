...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "aws-simpledb.gemspec", "lib/aws-simpledb.rb", "lib/aws-simpledb/error.rb", "lib/aws-simpledb/service.rb", "spec/aws-simpledb/service_spec.rb", "spec/spec_helper.rb", "Manifest"]
  s.has_rdoc = true
